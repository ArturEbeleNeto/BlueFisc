...
<head>
	...
	<link rel="shortcut icon" href="<%=Base_url%>resourses/images/gt_favicon.png">
	
	<link rel="stylesheet" media="screen" href="http://fonts.googleapis.com/css?family=Open+Sans:300,400,700">
	<link rel="stylesheet" href="<%=Base_url%>resourses/css/bootstrap.min.css">
	<link rel="stylesheet" href="<%=Base_url%>resourses/css/font-awesome.min.css">

	<!-- Custom styles for our template -->
	<link rel="stylesheet" href="<%=Base_url%>resourses/css/bootstrap-theme.css" media="screen" >
	<link rel="stylesheet" href="<%=Base_url%>resourses/css/main.css">
	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom" >
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<%=Base_url%>Inicio"><img src="<%=Base_url%>resourses/images/logo.png" alt=""></a>
			</div>
